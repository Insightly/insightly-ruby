  ...
  describe '#get_contact' do
    it 'returns a contact' do
      VCR.use_cassette('get_contact') do
        expect(Insightly.client.get_contact(id: contact_id)).to be_a(Contact)
      end
    end
  end
  ...
  describe '#get_contact_emails' do
    it 'returns a contacts emails' do
      VCR.use_cassette('get_contact_emails') do
        emails = Insightly.client.get_contact_emails(id: contact_id)
  ...
  describe '#get_contact_notes' do
    it 'returns a contacts notes' do
      VCR.use_cassette('get_contact_notes') do
        notes = Insightly.client.get_contact_notes(id: contact_id)
  ...
  describe '#get_contact_tasks' do
    it 'returns a contacts tasks' do
      VCR.use_cassette('get_contact_tasks') do
        tasks = Insightly.client.get_contact_tasks(id: contact_id)
  ...
  describe '#create_contact' do
    it 'creates and returns contact' do
      VCR.use_cassette('create_contact') do
        expect(Insightly.client.create_contact(contact: {first_name: 'Shark', last_name: 'Nado'})).to be_a(Contact)
      end
    end
  end
  ...
  describe '#update_contact' do
    it 'updates and returns contact' do
      VCR.use_cassette('update_contact') do
        contact = Insightly.client.get_contact(id: contact_id)
        expect(Insightly.client.update_contact(contact: contact)).to be_a(Contact)
      end
    end
  end
  ...
  describe '#delete_contact' do
    it 'returns a response with code 202' do
      VCR.use_cassette('delete_contact') do
        response = Insightly.client.delete_contact(id: contact_id)
  ...
  describe '#delete_contact_image' do
    it 'returns a response with code 202' do
      VCR.use_cassette('delete_contact_image') do
        response = Insightly.client.delete_contact_image(id: contact_id)
        expect(response.status).to eq(202)
      end
    end
  end
